...
##########################################################
###########Code used to remove headers of TK form################
...
def notify(msg):
    ...
    def destroy():
        root.destroy()
    root.after(5000, lambda:destroy())
    ...
    if msg== "Activated":
        notification_manager.success("Activating")
    elif msg== "Deativated":
        notification_manager.warning("Deactivated")
    else:
        notification_manager.alert(msg)
